      ...
      >
        ...
        >
          ...
          >
            ...
            <el-table-column prop="statsDatestr" label="日期" width="180" align="center" />
            <el-table-column prop="hospitalname" label="医院" min-width="250" align="center" />
            <el-table-column prop="newReport" label="新增指南" min-width="130" align="center" />
            <el-table-column prop="unlockReport" label="解锁指南" min-width="130" align="center" />
            <el-table-column prop="unlockprice" label="指南收入（人民币）" min-width="130" align="center" />
            <el-table-column prop="ordercount" label="订单数" min-width="130" align="center" />
            <el-table-column prop="orderprofit" label="订单分润（港币）" min-width="200" align="center" />
          </el-table>
        </div>
      </base-pagination>
    </section>
...
const table:TableInter = reactive({
  ...
  getList: debounce((more = true) => {
    ...
    api.get('/finance/hospital/getHospitalDaySalary', pickBy(params, (value: any, key: any) => {
