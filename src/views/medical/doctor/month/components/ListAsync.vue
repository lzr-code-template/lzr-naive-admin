      ...
      >
        ...
        >
          ...
          >
            ...
            <el-table-column prop="depname" label="科室" min-width="200" align="center" />
            <el-table-column prop="name" label="医生" min-width="120" align="center" />
            <el-table-column prop="newReportNum" label="新增指南" min-width="120" align="center" />
            <el-table-column prop="unLockedNum" label="已解锁指南" min-width="120" align="center" />
            <el-table-column prop="lockedNum" label="未解锁指南" min-width="120" align="center" />
            <el-table-column prop="conversionRatio" label="解锁转化比" min-width="120" align="center" />
            <el-table-column prop="totalPrice" label="已解锁指南金额（人民币）" min-width="200" align="center" />
          </el-table>
        </div>
      </base-pagination>
    </section>
...
const table:TableInter = reactive({
  ...
  getList: debounce((more = true) => {
    ...
    api.get('/datacenter/doctor/doctorMonthlyStats', pickBy(params, (value: any, key: any) => {
