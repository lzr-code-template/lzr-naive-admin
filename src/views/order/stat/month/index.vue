      ...
      >
        ...
        >
          ...
          >
            ...
            <el-table-column prop="platform" label="交易平台" min-width="250" align="center" />
            ...
            <el-table-column prop="cost" label="订单成本（港币）" min-width="120" align="center" />
            <el-table-column prop="profit" label="订单分润（港币）" min-width="120" align="center" />
...
const table:TableInter = reactive({
  ...
  getList: debounce((more = true) => {
    ...
    api.get('/order/getOrderStatMonthly', pickBy(params, (value: any, key: any) => {
